...
<script lang="ts">
import { computed, defineComponent, inject, ref, useRoute, onMounted } from '@nuxtjs/composition-api'
...
import xrpClient, { XrpClient } from '~/plugins/web3/xrp.client'
...
export default defineComponent({
  ...
  setup() {
    ...
    return { 
      ...
      chainTotal,
      //data
      loading, balanceData, error, stats, totalBalance, isWalletReady, messages, dialog, account }
  },
  head: {},
})
</script>
